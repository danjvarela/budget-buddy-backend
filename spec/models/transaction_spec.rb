...
RSpec.describe Transaction, type: :model do
  ...
  context "transfers validations" do
    ...
    it "should set category to nil after saving" do
      ...
      transaction.category = create :category, user: transaction.user
      transaction.save
  ...
  context "income validations" do
    ...
    it "should set from_financial_account to nil after saving" do
      ...
      transaction.from_financial_account = create :financial_account, user: transaction.user
      transaction.save
    ...
    it "should set to_financial_account to nil after saving" do
      transaction = build :income_transaction
      transaction.to_financial_account = create :financial_account, user: transaction.user
      transaction.save
    ...
    it "should have consistent type with its associated category" do
      transaction = build :income_transaction
      transaction.category = create :category, user: transaction.user, category_type: "expense"
      expect(transaction.save).to be false
    end
  end
  ...
  context "expense validations" do
    ...
    it "should have consistent type with its associated category" do
      transaction = build :expense_transaction
      transaction.category = create :category, user: transaction.user, category_type: "income"
      expect(transaction.save).to be false
    end
  end
end
